								...
								<td>
									<table class="row-content stack" align="center" border="0" cellpadding="0"
										...
										<tbody>
											<tr>
												<td class="column column-1" width="100%"
													style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 5px; padding-left: 15px; padding-right: 15px; padding-top: 5px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
													<div class="spacer_block block-1"
												...
												<td class="column column-1" width="100%"
													...
													<table class="table_block block-1" width="100%" border="0"
														...
														<tr>
															<td class="pad">
																<table
																	style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; width: 100%; table-layout: fixed; direction: ltr; background-color: transparent; font-family: Tahoma, Verdana, Segoe, sans-serif; font-weight: 400; color: #000000; text-align: left; letter-spacing: 0px; word-break: break-all;"
																	width="100%">
																	<thead
																		style="vertical-align: top; background-color: #EAEAEA; color: #505659; font-size: 14px; line-height: 120%; text-align: left;">
																		<tr>
																			<th width="100%"
																				style="padding: 10px; word-break: break-word; font-weight: 400; border-top: 1px solid #dddddd; border-right: 1px solid #dddddd; border-bottom: 1px solid #dddddd; border-left: 1px solid #dddddd;">
																				Valor pendiente</th>
																		</tr>
																	</thead>
																	<tbody
																		...
																		<tr>
																			<td width="100%"
																				style="padding: 10px; word-break: break-word; border-top: 1px solid #dddddd; border-right: 1px solid #dddddd; border-bottom: 1px solid #dddddd; border-left: 1px solid #dddddd;">
																				<strong>$
																					<?= $valor_pendiente ?></strong>
																			</td>
																		</tr>
																	</tbody>
																</table>
													...
													<table class="paragraph_block block-1" width="100%" border="0"
														...
														<tr>
															<td class="pad">
																<div
																	style="color:#555555;direction:ltr;font-family:Tahoma, Verdana, Segoe, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
																	<p style="margin: 0;">Realiza de nuevo el pago con
																		el mismo código de pago
																		<strong><?= $codigoPago ?></strong> seleccionando
																		la opción registrar deposito y te llegara el
																		comprobante electrónico a este correo
																		electrónico</p>
																</div>
															</td>
														</tr>
