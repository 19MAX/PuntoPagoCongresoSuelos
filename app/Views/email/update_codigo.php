        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <div class="content-d">
                    ...
                    <p> Tu inscripción se actualizo exitosamente</p>
                    ...
                    <p style="text-align: center;">Haz clic en <a
                            style="border-bottom: 2px solid #2d886a; text-decoration: none; border-radius: 10px; color:#2d886a; padding: 5px 5px; background-color: #e5e8ff;"
                            href="<?= base_url('?modal=metodo&codigoPago=' . $codigoPago) ?>"> <strong>PAGAR EN EL
                                SISTEMA</strong></a></p>
                    <hr>
